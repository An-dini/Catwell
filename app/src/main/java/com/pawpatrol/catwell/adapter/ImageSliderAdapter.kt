...
import com.pawpatrol.catwell.SliderData
import com.pawpatrol.catwell.databinding.ItemSliderBinding

data class ImageSliderAdapter(private val items: List<SliderData>) : RecyclerView.Adapter<ImageSliderAdapter.ImageViewHolder>(){
